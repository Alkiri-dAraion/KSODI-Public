...
Status: public v3.50 reference release; private canonical workbench origin retained. Lifted from the stable v3.42 projection line after Fable IK review, v3.50 Z hardening and Anne's 2026-07-21 public-release decision. Aligned with `Z_Vektor_v350.md`, `KSODI-Hangar_V350.md`, `KSODI-Glossar.md` and the `R0` relational-gate boundary.
