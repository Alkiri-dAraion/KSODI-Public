...
| What is mathematically defined, conventional, KSODI-specific or still empirically open? | [Research Status and Open Questions V350](./KSODI-Research-Status-and-Open-Questions_V350.md) | DOI-facing research-boundary matrix; it does not redefine formulas or establish validation |
| Where did the Hangar image come from, and where does the analogy stop? | [Hangar Origin and Analogy Companion V350](./KSODI-Hangar_Origin-and-Analogy-Companion_V350.md), then [KSODI Hangar V350](./KSODI-Hangar_V350.md) | explanatory origin and analogy boundary first; the formal Hangar note and versioned layer methods retain authority |
