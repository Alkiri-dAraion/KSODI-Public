...
- `KSODI-Light` is Layer 0 and belongs to the local agent / prompt side.
...
Layer 0 - KSODI-Light
  ...
  usable in one chat or through account, developer or system prompts
  prompt improvement / reflective self-alignment / lightweight local steering
  agent guidance; no external Observer calculation required
...
## Observer and Controller Boundary

KSODI Standard-Eval and KSODI-Full are observability architectures. Operational
use requires a separate Observer architecture that reconstructs and evaluates
observable states and trajectories. These layers do not decide, intervene or
steer by themselves.
...
Automated alignment, feedback routing or intervention requires a separate
Controller architecture with declared governance corridors. This Controller
architecture remains a Future-Work publication line and must not collapse back
into either the Observer or the observed agent.
...
- [Layer 7 - Optional Pace Overlay Research](./KSODI-Eval-Variants/KSODI-Full/Full_v350/layer-7-r-pace/README.md)
- [Layer 8 - Optional Voice / Rhythm-Timing and Signal-Media Research](./KSODI-Eval-Variants/KSODI-Full/Full_v350/layer-8-future-signal-media/README.md)
...
[`KSODI-Standard-Eval/archive_historical-v33`](./KSODI-Eval-Variants/KSODI-Standard-Eval/archive_historical-v33/README.md).
