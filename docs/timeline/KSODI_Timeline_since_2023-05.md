...
| upcoming | IK_rel review before possible public Layer 5 release | Anne, ELKIM, FABLE, WAVE, VSELKIM/Codex | Private review of `IK_rel` after the public `R0` gate. ELKIM reviews semantic boundaries, FABLE reviews formal consistency, WAVE reviews outside-reader clarity, and VSELKIM/Codex handles repository changes after Anne's approval. | Release decision remains with Anne. No public Layer 5 release is implied by this timeline entry. |
